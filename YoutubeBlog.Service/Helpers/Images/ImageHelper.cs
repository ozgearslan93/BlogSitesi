...
namespace YoutubeBlog.Service.Helpers.Images
{
    public class ImageHelper : IImageHelper
    {
        ...
        private const string imgFolder = "images";  //const anahtar kelimesi, yalnızca değeri sabit olan türlerde kullanılabilir.
        private const string articleImagesFolder = "article-images";
        private const string userImagesFolder = "user-images";

        public ImageHelper(IWebHostEnvironment env) //root ta image dosyarımızı tutmamıza yarayacak 
        {
            this.env = env;
