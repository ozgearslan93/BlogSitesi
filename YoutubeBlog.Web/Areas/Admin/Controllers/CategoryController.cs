...
{
    [Area("Admin")]    // sayfanın gidecegi area ları Controller ında belirtmemiz gerekiyor 
    public class CategoryController : Controller
    {
        ...
        // ınterfaceleri olusturdugumuz yapıcı metotlar ıcersınde cagırıyoruz.sonrasında da field lerini olusturuyoruz
        {
        ...
        public async Task<IActionResult> Add(CategoryAddDto categoryAddDto)
        {
            ...
            if (result.IsValid)
            {
                ...
                toast.AddSuccessToastMessage(Messages.CategoryMessages.Add(categoryAddDto.Name), new ToastrOptions { Title = "İşlem Başarılı" });
        ...
        public async Task<IActionResult> AddWithAjax([FromBody] CategoryAddDto categoryAddDto)
        {
            ...
            if (result.IsValid)
            {
                ...
                return Json(Messages.CategoryMessages.Add(categoryAddDto.Name));
            }
            else
            {
        ...
        public async Task<IActionResult> Update(CategoryUpdateDto categoryUpdateDto)
        {
            ...
            if (result.IsValid)
            {
                ...
                toast.AddSuccessToastMessage(Messages.CategoryMessages.Update(name), new ToastrOptions() { Title = "İşlem Başarılı" });
                return RedirectToAction("Index", "Category", new { Area = "Admin" });
        ...
        public async Task<IActionResult> Delete(Guid categoryId)
        {
            ...
            toast.AddSuccessToastMessage(Messages.CategoryMessages.Delete(name), new ToastrOptions() { Title = "İşlem başarılı" });
            return RedirectToAction("Index", "Category", new { Area = "Admin" });
        ...
        public async Task<IActionResult> UndoDelete(Guid categoryId)
        {
            ...
            toast.AddSuccessToastMessage(Messages.CategoryMessages.UndoDelete(name), new ToastrOptions() { Title = "İşlem başarılı" });
            return RedirectToAction("Index", "Category", new { Area = "Admin" });
